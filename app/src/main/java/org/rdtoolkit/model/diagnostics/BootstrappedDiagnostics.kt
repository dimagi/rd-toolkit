...
fun generateBootstrappedDiagnostics(): MutableMap<String, RdtDiagnosticProfile> {
    ...
    var quicktest = ConcreteProfile("debug_mal_pf_pv", "FastResolve Malaria P.f./P.v", 45,90, listOf(pf_result, pv_result))
    var lightnighttest = ConcreteProfile("debug_sf_mal_pf_pv", "LightningQuick Malaria P.f./P.v", 5,15, listOf(pf_result, pv_result))
